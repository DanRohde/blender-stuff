import bpy
import numpy as np
from .objects import create_material, create_bar, create_cylinder, clone_and_scale_object, render_text_object
...
def draw_2d_axes(target, props, data):
    ...
    if props.axes_y:
        clone_and_scale_object(target, axis, (props.axes_thickness, props.axes_thickness, props.size[1]),(cx, cy, cz), rot=(-np.pi/2, 0, 0))
        if props.axes_labels:
