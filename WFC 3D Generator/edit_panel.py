...
class WFC3D_PT_EditPanel(bpy.types.Panel):
    ...
    def draw(self, context):
        ...
        if props.edit_constraints == "distance":
            ...
            if not props.auto_save: box.operator("object.wfc_update_constraints")
        row = layout.row()
        row.operator("object.wfc_open_web_link", text="Visit GitHub to get help").url = "https://github.com/DanRohde/blender-stuff/blob/main/WFC%203D%20Generator/constraints.md#"+props.edit_constraints+"-constraints"
