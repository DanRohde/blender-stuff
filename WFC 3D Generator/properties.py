...
class WFC3DProperties(bpy.types.PropertyGroup):
    ...
    entropy_type: bpy.props.EnumProperty(name="Entropy", items=[('number','Number','Number of permitted elements.'),('optimized','Optimized','Optimized weight-based entropy.'),('shannon','Shannon','Shannon-based entropy.')], update=handle_seed_change)
