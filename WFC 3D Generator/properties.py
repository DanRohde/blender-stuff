...
class WFC3DProperties(bpy.types.PropertyGroup):
    ...
    location: bpy.props.FloatVectorProperty(name="", description="Location", subtype="TRANSLATION", default=(0.0, 0.0, 0.0), precision=3)
    use_cursor: bpy.props.BoolProperty(name="", description="Use cursor location (rotation will be ignored)", default=False,)
    ...
    remove_target_collection: bpy.props.BoolProperty(name="", description="Remove existing target collection",)
    hide_last_target_collections: bpy.props.BoolProperty(name="", description="Hide last target collection(s)", default=False,)
