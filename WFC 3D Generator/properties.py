...
class WFC3DRenderResult(bpy.types.PropertyGroup):
    ...
    object_count_collapsed: bpy.props.BoolProperty(default=True, description="C: Cell count, E: Empty cells, T: Time required for generation/render/total; Click to show/hide object statistics.")
