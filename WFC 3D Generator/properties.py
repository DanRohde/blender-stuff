...
class WFC3DEditPanelNeighborMultiSelItem(bpy.types.PropertyGroup):
    obj: bpy.props.PointerProperty(type=bpy.types.ID)
    selected: bpy.props.BoolProperty(default=False, update=auto_save, name="", description="(De)Select building block.")

class WFC3DRotationPanelMultiSelItem(bpy.types.PropertyGroup):
    obj: bpy.props.PointerProperty(type=bpy.types.ID)
    selected: bpy.props.BoolProperty(default=False, name="", description="(De)Select building block.")
...
class WFC3DRegionFrequencyListItem(bpy.types.PropertyGroup):
    ...
    regfreq_min: bpy.props.IntVectorProperty(size=3, update=auto_save, name="min", description="Region min", default=PROP_DEFAULTS["regfreq_min"], subtype="XYZ")
    regfreq_max: bpy.props.IntVectorProperty(size=3, update=auto_save, name="max", description="Region max", default=PROP_DEFAULTS["regfreq_max"], subtype="XYZ")
...
class WFC3DObjectFrequencyListItem(bpy.types.PropertyGroup):
    ...
    objfreq_axes: bpy.props.IntVectorProperty(size=3, min=-1, update=auto_save, name="Axes", description="Axes frequency max.", default=PROP_DEFAULTS["objfreq_axes"], subtype="XYZ")
...
class WFC3DFixedPositionListItem(bpy.types.PropertyGroup):
    fixed_position_xyz: bpy.props.IntVectorProperty(name="",
                                                    ...
                                                    default=PROP_DEFAULTS['fixed_position_xyz'], update=auto_save, subtype="XYZ")
    fixed_position_pct: bpy.props.FloatVectorProperty(name="", description="Fixed Position for a building block", min=0, max=100, precision=1, default=PROP_DEFAULTS['fixed_position_pct'], update=auto_save, subtype="XYZ")
...
class WFC3DEmptyNeighborListItem(bpy.types.PropertyGroup):
    ...
    selected: bpy.props.BoolProperty(default=False, update=auto_save, name="", description="(De)Select direction.")
...
class WFC3DRegionProbabilityListItem(bpy.types.PropertyGroup):
    ...
    regprob_min: bpy.props.IntVectorProperty(size=3, update=auto_save, name="min", description="Region min", default=PROP_DEFAULTS['regprob_min'], subtype="XYZ")
    regprob_max: bpy.props.IntVectorProperty(size=3, update=auto_save, name="max", description="Region max", default=PROP_DEFAULTS['regprob_max'], subtype="XYZ")
...
class WFC3DSeedsListItem(bpy.types.PropertyGroup):
    ...
    grid_size: bpy.props.IntVectorProperty(name="", description="Size of the 3D grid", size=3, subtype="XYZ")
    ...
    selected: bpy.props.BoolProperty(default=False, name="", description="(De)Select random seed bookmark.")
...
class WFC3DDistanceListItem(bpy.types.PropertyGroup):
    distance: bpy.props.IntVectorProperty(name="Distance", description="Minimum cell distance", default=PROP_DEFAULTS['distance'], min=0, update=auto_save, subtype="XYZ")
    ...
    distance_position: bpy.props.IntVectorProperty(name="Position", description="Grid position", update=auto_save, default=PROP_DEFAULTS['distance_position'], subtype="XYZ")
    distance_position_pct: bpy.props.FloatVectorProperty(name="", description="Percentage-based relative grid position", min=0, max=100, precision=1, default=PROP_DEFAULTS['distance_position_pct'], update=auto_save, subtype="XYZ")
...
class WFC3DActiveConstraintsListItem(bpy.types.PropertyGroup):
    selected: bpy.props.BoolProperty(default=False, name="", update=handle_active_constraints_changes, description="Click to (de)activate constraint.")
...
class WFC3DProperties(bpy.types.PropertyGroup):
    ...
    grid_size: bpy.props.IntVectorProperty(name="", description="Size of the 3D grid", size=3, default=(5, 5, 5), min=1, subtype="XYZ")
    allow_large_grid_size: bpy.props.BoolProperty(name="Allow a large grid", description="Allow a grid size larger then 10,000 cells. This can cause Blender to crash.", default=False)
    ...
    auto_detect_spacing: bpy.props.BoolProperty(name="", description="Automatic cell space detection", default=False,)
    ...
    random_start_cell: bpy.props.BoolProperty(name="", description="Random start cell", default=False, update=handle_seed_change)
    entropy_type: bpy.props.EnumProperty(name="Entropy", items=[('number','Number','Entropy = Number of permitted elements.'),('optimized','Optimized','Entropy = Optimized Shannon entropy.'),('shannon','Shannon','Entropy = Shannon entropy.')], update=handle_seed_change)
    ...
    link_objects: bpy.props.BoolProperty(name="", description="Link new objects instead of copying them. (recommended)", default = True,)
    copy_modifiers: bpy.props.BoolProperty(name="", description="Copy modifiers to linked objects.",)
    ...
    randomize_seed: bpy.props.BoolProperty(name="Randomize the random seed", description="Randomize the random seed rather than incrementing it sequentially", default=False,)
    ...
    scale_min : bpy.props.FloatVectorProperty(name="Min", description="Scale minimum", default=PROP_DEFAULTS["scale_min"], update=auto_save, subtype="XYZ")
    scale_max : bpy.props.FloatVectorProperty(name="Max", description="Scale maximum", default=PROP_DEFAULTS["scale_max"], update=auto_save, subtype="XYZ")
    scale_steps : bpy.props.FloatVectorProperty(name="Steps", description="Scale steps", default=PROP_DEFAULTS["scale_steps"], update=auto_save, subtype="XYZ")
    ...
    flipping: bpy.props.FloatVectorProperty(name="Flipping", description="Flipping probability on given axes", default=PROP_DEFAULTS["flipping"], update=auto_save, min=0, max=1, subtype="XYZ")
    ...
    freq_axes: bpy.props.IntVectorProperty(name="Axes",description="Axes frequency max", default=PROP_DEFAULTS["freq_axes"], size=3, min=-1, update=auto_save, subtype="XYZ")
    ...
    freq_any_axes: bpy.props.IntVectorProperty(name="Any Axes",description="Any Object in Axes frequency max", default=PROP_DEFAULTS["freq_any_axes"], size=3, min=-1, update=auto_save, subtype="XYZ")
    ...
    sym_mirror_axes : bpy.props.BoolVectorProperty(name="Axes",description="Symmetry Axes", default=PROP_DEFAULTS["sym_mirror_axes"], update=auto_save, subtype="XYZ")
    ...
    sym_rotate_axis : bpy.props.FloatVectorProperty(name="Axis",description="Rotation Axis", default=PROP_DEFAULTS["sym_rotate_axis"], update=auto_save, subtype="XYZ")
    ...
    region_min: bpy.props.IntVectorProperty(name="min",description="Region minimum", default=PROP_DEFAULTS["region_min"],min=-1, update=auto_save, subtype="XYZ")
    region_max: bpy.props.IntVectorProperty(name="max",description="Region maximum", default=PROP_DEFAULTS["region_max"],min=-1, update=auto_save, subtype="XYZ")
    ...
    dim_xyz : bpy.props.IntVectorProperty(name="Dimensions",description="Dimensions of a building block.",min=1,default=PROP_DEFAULTS["dim_xyz"], update=auto_save, subtype="XYZ")
    ...
    noise_transf_gain : bpy.props.FloatProperty(name="Gain", description="Scaling applied to the values.", default=PROP_DEFAULTS['noise_transf_gain'], update=auto_save)
    ...
    geo_match_edges: bpy.props.BoolProperty(name="Edges", description="Match edges (fast)", default=PROP_DEFAULTS["geo_match_edges"], update=auto_save)
    geo_match_faces: bpy.props.BoolProperty(name="Faces", description="Match faces (slow)", default=PROP_DEFAULTS["geo_match_faces"], update=auto_save)
    ...
    rt_offset: bpy.props.FloatVectorProperty(size=3, name="Offset", description="Offset location for the created building blocks", subtype="TRANSLATION",  precision=3)
...
class WFC3DAddonPreferences(bpy.types.AddonPreferences):
    ...
    remove_target_collection: bpy.props.BoolProperty(name="Remove Target(s)", description="Remove target(s)", default=True, update=handle_update_pref)
